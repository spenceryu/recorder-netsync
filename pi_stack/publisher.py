'''
This version of the publisher assumes that all clients may not be connected to the same WiFi network. It is meant to be run on the access point Pi, not client Pi's.
'''
